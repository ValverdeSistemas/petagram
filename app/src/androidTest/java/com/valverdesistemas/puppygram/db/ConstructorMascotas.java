package com.valverdesistemas.puppygram.db;
...
public class ConstructorMascotas {
    ...
    public void insertarAlgunaMascota(BaseDatos db){
        ...
        contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_LIKES, 2);
        db.insertarMascota(contentValues);
        ...
        contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_NOMBRE, "Mascota 4");
        contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_FOTO, R.drawable.puppy4);
        contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_LIKES, 4);

        contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_NOMBRE, "Mascota 4");
        contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_FOTO, R.drawable.puppy5);
        contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_LIKES, 1);
